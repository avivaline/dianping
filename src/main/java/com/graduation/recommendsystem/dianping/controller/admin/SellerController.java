...
import com.graduation.recommendsystem.dianping.request.PageQuery;
import com.graduation.recommendsystem.dianping.request.SellerCreateReq;
...
public class SellerController {
    ...
    public String create(@Valid SellerCreateReq sellerCreateReq, BindingResult bindingResult) throws BusinessException {
        ...
        sellerCreateReq.setName(sellerCreateReq.getName());
